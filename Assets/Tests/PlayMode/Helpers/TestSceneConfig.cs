namespace DuskBlade.Tests
{
    public static class TestSceneConfig
    {
        ...
        public static string LobbyScenePath { get { return GameFlowScenePaths[1]; } }
        public static string RunScenePath { get { return GameFlowScenePaths[2]; } }
        public static string RunScene2Path { get { return GameFlowScenePaths[3]; } }
        public static string FinalBossScenePath { get { return GameFlowScenePaths[4]; } }
