...
public static class SettingsLocalizationData
{
    ...
    private static readonly (string en, string vi)[] Entries = new (string, string)[]
    {
        ...
        // ========== NPC: TRAN SUY ANH KHOA (bàn thờ rune) ==========
        ...
        // ========== NPC: UONG QUOC TRUNG (kho lưu trữ) ==========
        ...
        // ========== QUEST: TRIAL OF THE EXPEDITION (Dat Vit / Point Khoa) ==========
        ...
        // ========== QUEST: RECORD OF VALOUR / ACHIEVEMENTS (Uong Quoc Trung) ==========
        ...
        // ========== QUEST: HALL OF FAME / LEADERBOARD (Uong Quoc Trung) ==========
        ...
        // ========== QUEST: GETTING ACQUAINTED (BeeNgoo) ==========
        ...
        // ========== QUEST: AWAKEN THE RELIC / GACHA (LaiDuyLong) ==========
        ...
        // ========== QUEST: MERCHANT'S WARES / SHOP (LaiDuyLong) ==========
        ...
        // ========== QUEST: CHOOSE YOUR CHAMPION (Pedestal) ==========
        ...
        // ========== QUEST: HIGH ROLLER'S GAMBLE (Phuc) ==========
        ...
        ("Come back after your next run if your pockets feel heavy again.", "Hãy quay lại sau chuyến đi tiếp theo nếu túi tiền của bạn lại rủng rỉnh nhé."),
                ...
                // ========== NPC IDLE DIALOGUES: THU KHOA (Rune / Altar) ==========
        ...
        // ========== NPC IDLE DIALOGUES: BEE NGOO (Guardian / Scout) ==========
        ...
        // ========== NPC IDLE DIALOGUES: PHUC / GAMBLER ==========
        ...
        // ========== NPC IDLE DIALOGUES: DAT VIT (Expedition Master) ==========
        ...
        // ========== NPC IDLE DIALOGUES: MARIA OZAWA (Mystic / Scholar) ==========
        ...
        // ========== NPC IDLE DIALOGUES: LAI DUY LONG (Shop & Gacha) ==========
        ("Talk - Lai Duy Long", "Trò chuyện - Lại Duy Long"),
        ("LaiDuyLon", "Lại Duy Long"),
        ("Lai Duy Long", "Lại Duy Long"),

        // ========== NPC IDLE DIALOGUES: UONG QUOC TRUNG (Leaderboard & Achievements) ==========
        ...
        // ========== DIALOGUE CHOICES KÈM TRẠNG THÁI KHÓA ==========
    ...
    private static readonly (Regex regex, string replacement)[] RegexEntries = new (Regex, string)[]
    {
        ...
        // Dịch tự động đuôi (Locked) có mã màu xám trong Dialogue Choices: "Achievement <color=#888888>(Locked)</color>"
        (new Regex(@"^Achievement\s+<color=[^>]+>\(Locked\)</color>$", RegexOptions.IgnoreCase), "Thành tích <color=#888888>(Đã khóa)</color>"),
        (new Regex(@"^Leaderboard\s+<color=[^>]+>\(Locked\)</color>$", RegexOptions.IgnoreCase), "Bảng xếp hạng <color=#888888>(Đã khóa)</color>"),
        (new Regex(@"^Shop\s+<color=[^>]+>\(Locked\)</color>$", RegexOptions.IgnoreCase), "Cửa hàng <color=#888888>(Đã khóa)</color>"),
        (new Regex(@"^Gacha\s+<color=[^>]+>\(Locked\)</color>$", RegexOptions.IgnoreCase), "Gacha <color=#888888>(Đã khóa)</color>"),
