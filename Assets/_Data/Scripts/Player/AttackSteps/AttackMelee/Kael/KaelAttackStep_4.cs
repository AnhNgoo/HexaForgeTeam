...
public class KaelAttackStep_4 : AttackStepBase
{
    public KaelAttackStep_4(CharacterBase character) : base(character)
    {

    }

    public override string AttackStateName => "MeleeAttack_4";
    ...
    public override async void Attack(CharacterBase character)
    {
        ...
        {
            kael.CharacterMeleeHitbox.AttackHitBox(kael.hitEffect_2, true);
