...
{
    [Tooltip("Mỗi phần tử tạo ra một thẻ. Chỉ dùng từ 2 đến 3 slot.")]
    ...
    private bool IsValid(BossRewardCandidate candidate, HashSet<string> usedKeys)
    {
        return candidate != null && candidate.reward != null && !usedKeys.Contains(candidate.reward.UniqueKey);
    }
}
