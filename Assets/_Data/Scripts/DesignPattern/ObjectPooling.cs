...
public enum PoolType
{
    ...
    DissolveEffect = 107,
    AntlerStaff = 108,
    Pickup_AntlerStaff = 109,
    GroveStaff = 110,
    Pickup_GroveStaff = 111,
    WildbarkStaff = 112,
    Pickup_WildbarkStaff = 113,
    Solren = 114,
    Pickup_Solren = 115,
    ValdrisAxe = 116,
    Pickup_ValdrisAxe = 117,
    AurethiaScepter = 118,
    Pickup_AurethiaScepter = 119,
    VesperithStaff = 120,
    Pickup_VesperithStaff = 121,
    AetherionGreatsword = 122,
    Pickup_AetherionGreatsword = 123,
    SeraphineLance = 124,
    Pickup_SeraphineLance = 125,
    Caelen = 126,
    Pickup_Caelen = 127,
    Pyren = 128,
    Pickup_Pyren = 129,
    ...
    Pickup_Zorya = 133,
    KaelornStaff = 134,
    Pickup_KaelornStaff = 135,
    MournveilStaff = 136,
    Pickup_MournveilStaff = 137,
    VeyrinStaff = 138,
    Pickup_VeyrinStaff = 139,
    AverinSword = 140,
    Pickup_AverinSword = 141,
    KaelisBlade = 142,
    Pickup_KaelisBlade = 143,
    Ruben = 144,
    Pickup_Ruben = 145,
    EnemyBruteBoss = 1001,
